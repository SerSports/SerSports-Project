/*
File: BrowseMlbPlayers.java
Author:	
Date:	

Description: GUI for displaying/searching the Mlb Players database
...
/**
Class: BrowseMlbPlayers

Description: GUI for displaying/searching Mlb Players database
*/
public class BrowseMlbPlayers extends JPanel {
	
	// Protected Members
	protected JTextField txtFirstName;
	protected JTextField txtLastName;
	protected JTextField txtTeam;
	protected JButton SubmitMlbSearch;
	...
	*/
	public BrowseMlbPlayers() {
		...
		SubmitMlbSearch = new JButton("Submit");
		SubmitMlbSearch.setBounds(38, 255, 117, 29);
		add(SubmitMlbSearch);
