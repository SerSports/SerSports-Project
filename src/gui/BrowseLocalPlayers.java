...
/**
 * GUI used to display all components of the Browse Local Players page
 * 
 * @author SerSports
 */
public class BrowseLocalPlayers extends JPanel
{
	...
	protected ModifiedJButtonStyle1 SubmitLocalSearch = new ModifiedJButtonStyle1(
			"Submit");
	protected ModifiedJButtonStyle1 btnSeePlayerStats = new ModifiedJButtonStyle1(
			"See Player Stats");
	...
	/**
	 * Creates the panel for the Browse Local Players page
	 */
	public BrowseLocalPlayers()
	{
		...
		/*
		 * Search field for a local player's first name
		 */
		...
		/*
		 * Search field for a local player's last name
		 */
		...
		/*
		 * Search field for a local player's team
		 */
		...
		/*
		 * Table containing statistics for fielding of a selected local player
		 */
		...
		/*
		 * Table containing statistics for pitching of a selected local player
		 */
		pitchingTable = new ModifiedJTable(new DefaultTableModel(null, new Object[] {
				"Won", "ERA", "SAVES", "HITS", "HOLDS", "RUNS", "HBP" }));
		...
		/*
		 * Table containing statistics for batting of a selected local player
		 */
		battingTable = new ModifiedJTable(new DefaultTableModel(null, new Object[] {
				"Won", "AB", "H", "RBI", "1B", "2B", "3B", "Runs", "SB", "HR", "SO" }));
