...
/**
 * GUI used as the backbone of the application that provides all transition functionality
 * between pages
 * 
 * @author SerSports
 */
public class MainGUI
{
	...
	public static void setHourGlass(Boolean hourGlassOn)
	{
		if (singleton != null)
		{
			if (hourGlassOn)
			{
				singleton.mainFrame.setCursor(Cursor
	...
	/**
	 * Displays all components of the upper tabs together
	 */
	public MainGUI()
	{
		...
		mainFrame.setLocation(dim.width / 2 - mainFrame.getSize().width / 2, dim.height
				/ 2 - mainFrame.getSize().height / 2);
	}
