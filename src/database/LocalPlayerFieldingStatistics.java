...
public class LocalPlayerFieldingStatistics {
	...
	*/
	...
	public static ArrayList<LocalPlayerFieldingStatistics> getStatisticsFromDatabase(int localPlayerId) {
		...
		if (rs != null) {
			...
			try {
				while(rs.next()){
					LocalPlayerFieldingStatistics player = new LocalPlayerFieldingStatistics(rs);
