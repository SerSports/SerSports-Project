/*
File: MlbPlayerPitchingStatistics.java
...
public class MlbPlayerPitchingStatistics {		
		// Constants
		private static final String TABLE_NAME = "MlbPlayersPitchingStatistics";  
		private static final String FIELD_ID = "MlbPlayersPitchingStatisticsID"; 
		...
		*/
		private MlbPlayerPitchingStatistics(ResultSet rs) {
			try {
		...
		public static ArrayList<MlbPlayerPitchingStatistics> getStatisticsFromDatabase(int MlbPlayerId) {
			ArrayList<MlbPlayerPitchingStatistics> resultList = new ArrayList<MlbPlayerPitchingStatistics>();
			...
			if (rs != null) {
				...
				try {
					while(rs.next()){
						MlbPlayerPitchingStatistics player = new MlbPlayerPitchingStatistics(rs);
